package bk8_02WorkingwithFileStreams;
...
public class WriteBinaryFile {
	public static void main(String[] args) {
		...
		DataOutputStream out = openOutputStream("/home/jonathansiyanata/Downloads/Boot Camp/Boot Camp II/src/bk8_02WorkingwithFileStreams/movies.dat");
		for (Movie m : movies)
			writeMovie(m, out);
		closeFile(out);
	}
